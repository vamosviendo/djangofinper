...
urlpatterns = [
    ...
    path('mov_sheet/', views.MovTableView.as_view(), name='mov_sheet'),
    ...
    # Vistas basadas en funciones, destinadas a verificar y corregir posibles
    # errores en saldos de cuentas.
